<div class="col-md-4">
  ...
  <div class="widget">
    ...
    <div id="owl-carousel-3" class="owl-carousel owl-theme center-owl-nav">
      ...
      <article class="article">
        <div class="article-img">
          <a href="#">
            <img src="<?php echo base_url();?>assets/magnews/img/img-md-3.jpg" alt="">
          </a>
      ...
      <article class="article">
        <div class="article-img">
          <a href="#">
            <img src="<?php echo base_url();?>assets/magnews/img/img-md-4.jpg" alt="">
          </a>
          <ul class="article-info">
            <li class="article-type"><i class="fa fa-file-text"></i></li>
          </ul>
    ...
    <article class="article widget-article">
      <div class="article-img">
        <a href="#">
          <img src="<?php echo base_url();?>assets/magnews/img/img-widget-1.jpg" alt="">
        </a>
      </div>
      <div class="article-body">
        <h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
    ...
    <article class="article widget-article">
      <div class="article-img">
        <a href="#">
          <img src="<?php echo base_url();?>assets/magnews/img/img-widget-2.jpg" alt="">
        </a>
      </div>
      <div class="article-body">
        <h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
    ...
    <article class="article widget-article">
      <div class="article-img">
        <a href="#">
          <img src="<?php echo base_url();?>assets/magnews/img/img-widget-3.jpg" alt="">
        </a>
      </div>
      <div class="article-body">
        <h4 class="article-title"><a href="#">Duis urbanitas eam in, tempor consequat.</a></h4>
