    ...
    <section class="content">
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#tab_con" data-toggle="tab">Contestants</a></li>
          <li><a href="#tab_u" data-toggle="tab">User Accounts</a></li>
        </ul>
            ...
            <div class="box-default">
              ...
              <div class="box-footer">
                <a href="javascript:void(0);" class="btn btn-info btn-sm btn-flat" data-toggle="modal" data-target="#modal_add_contestant">
                  <span class="fa fa-plus-square-o"></span> New Criteria
                </a>
              </div>
            </div>
          </div>
...
<script>
  <?php include 'includes/script/event.handler.user.settings.js';?>
</script>
</body>
</html>
