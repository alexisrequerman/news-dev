<head>
  ...
  <title>CLTV36 | STAR MILL SCORING SYSTEM</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/admin-lte/bower_components/datatables.net/download/css/buttons.dataTables.min.css">
  <!-- Ionicons -->
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/plugin/select2-bootstrap/dist/select2-bootstrap.min.css">
  <!-- Jquery-Confirm -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/plugin/jquery-confirm/jquery-confirm.min.css">

  <!-- SUMMERNOTE -->
  <link rel="stylesheet" href="<?php echo base_url();?>assets/note/summernote.css">
  <link rel="stylesheet" href="<?php echo base_url();?>assets/note/summernote-bs3.css">
</head>
